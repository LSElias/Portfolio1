          ...
          <div className="container infobox">
            ...
            <div className="row py-3">
              ...
              <div className="col-md-6 description">
                <h4>
                  {" "}
                  A website for a company with the purpose of increasing
                  awareness of the benefits that recycling has. Encouraging
                  customers to recycle in exchange for e-coins. These coins can
                  be used to purchase multiple coupons displayed on the website,
                  ranging from household utensils to free meals at affiliated
                  restaurants.{" "}
                </h4>
                <h4>
                  This university project was made during 2023, from the end of
                  september to the beggining of december. It has multiple
                  features, such as login authentication, user registration,
                  facturation of the recycling exchange and reward coupons, and
                  many others.
                </h4>
              </div>
            </div>
